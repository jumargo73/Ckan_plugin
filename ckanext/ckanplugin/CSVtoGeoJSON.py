...
class CSVtoGeoJSONPlugin(SingletonPlugin):
    ...
    def after_dataset_update(self,context: Context, pkg_dict: dict[str, Any]):
        ...
        val = tk.request.form.get('sello_excelencia') or pkg_dict.get('sello_excelencia')
        ...
        pkg = tk.get_action('package_show')({'user': context.get('user')}, {'id': pkg_id})
        ...
        tk.get_action('package_patch')(new_context, {'id': pkg_id, 'extras': extras})
    ...
    def after_dataset_search(self,search_results: dict[str, Any], search_params: dict[str, Any]):
        ...
        try:
            ...
            #contador_action = tk.get_action('contador_get')
            context = {
                'model': model,
                'session': model.Session,
                'user': tk.g.user or tk.config.get('ckan.site_id')
            }
    ...
    def get_filas_columnas(self,id,context):
        try:
            ...
            datastore_response = tk.get_action('datastore_search')(context,{'id': id})
